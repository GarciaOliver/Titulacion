<?php
    ...
    class Docente{
        ...
        public function listarDocentesIngresados($usu_id,$idio_id){
            $consulta = "call resumenes_ist17j.sp_docentes(3, $usu_id, $idio_id, 0);";
        ...
        public function agregarDocente($usu_id,$idio_id){
            $consulta = "call resumenes_ist17j.sp_docentes(0, $usu_id, $idio_id, 0);";
            $resultado = ejecutarConsultaSP($consulta);
            return $resultado;
        }

        public function buscarDocente($usu_id){
            $consulta = "call resumenes_ist17j.sp_docentes(1, $usu_id, 0, 0);";
            $resultado = ejecutarConsultaSP($consulta);
            return $resultado;
        }

        public function editarDocente($usu_id,$doc_permiso){
            $consulta = "call resumenes_ist17j.sp_docentes(2, $usu_id, 0, $doc_permiso);";
            $resultado = ejecutarConsultaSP($consulta);
            return $resultado;
        }
